...
class SecurityPolicy:
    ...
    def __init__(self, protected=True, event_sink=None):
        self.protected = protected
        self.events = []
        # Labo 6 : callback optionnel (observabilité). La politique ne connaît pas
        # le module d'observabilité — elle se contente de publier ses événements,
        # que l'application rattache à la trace courante. Couplage faible.
