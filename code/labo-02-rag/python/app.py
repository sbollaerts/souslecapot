"""Assistant Bikaroo — Labo 2 : RAG documentaire.

Ce labo enrichit le chatbot du labo 1 avec une chaîne RAG (Retrieval-Augmented
Generation) : les questions du lecteur peuvent être répondues à partir des
documents internes de Bikaroo, et non plus des seules connaissances générales
du modèle. Une bascule « Avec RAG / Sans RAG » permet de comparer les deux
comportements sur une même question.
"""
...
# comportement attendu pour les questions volontairement hors-corpus.
...
# L'index est mis en cache sur disque : seul le premier lancement calcule les
# embeddings du corpus. Voir rag.ensure_index().
